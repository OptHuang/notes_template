...
\newtheorem*{blanketassumption}{Blanket Assumption}
...
\newcommand{\yl}[1]{{\color{darkyellow}#1}}  % For comments by Cunxin Huang
...
Hong Kong, China ({\tt cun-xin.huang@connect.polyu.hk}).
}
% \and Zaikun Zhang\thanks{
% School of Mathematics, Sun Yat-sen University,
% Guangzhou, China ({\tt zhangzaikun@mail.sysu.edu.cn}).
% }
}
